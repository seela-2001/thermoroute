...
export function PricingFrequencyToggle({
    ...
    return (
        <div
            className={cn(
                'bg-gray-200 mx-auto flex w-fit rounded-full border border-gray-300 p-1',
                props.className,
            )}
            {...props}
        >
            {frequencies.map((freq) => (
                ...
                >
                    <motion.span
                        ...
                        className={cn(
                            'absolute inset-0 z-10 rounded-full flex items-center justify-center',
                            frequency === freq ? 'bg-gray-700 text-white' : 'text-gray-700'
                        )}
                    >
                        {freq}
                    </motion.span>
